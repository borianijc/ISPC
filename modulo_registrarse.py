...
def Ventana_Registro(abrir):
    ...
    #---------------Botones registrarse/salir-----------
        ...
        boton_salir= Button(ventana_registro,text="Salir",height=1,width=10, command= ventana_registro.destroy)
